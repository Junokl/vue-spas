<template>
	<div>
		<header v-if="status=='register'||status=='login'||status=='Ordermonth'||status=='Listdetail'||status=='workType'||status=='user'||status=='mystore'||status=='staffWroking'" class="inverted bar" style="position: relative;"><button @click="back"><span
